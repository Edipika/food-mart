    ...
    <Layout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="text-sm text-gray-500 flex items-center space-x-2">
          ...
          <a href="/fresh-fruits" className="hover:underline">
            Fresh Fruits
          </a>
          <AiOutlineRight size={12} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 py-8">
        ...
        <div>
          ...
          {/* Add Button */}
          {/* <button className="mt-6 w-full bg-pink-500 text-white py-2 rounded-md hover:bg-pink-600">
            Add
          </button> */}
